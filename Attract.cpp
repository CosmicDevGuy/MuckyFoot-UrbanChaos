...
#include "../Headers/cam.h"
	...
	#include "c:\ps\psx\include\ctrller.h"	//@CosmicDevGuy (2018/05/23): TODO - check if this file exists in PSX/PS1-SDK
	extern ControllerPacket PAD_Input1,PAD_Input2;
#endif
#include "../Headers/startscr.h"
#include "../Headers/briefing.h"
#define	DEMO
...
// ... getting old menus back (@CosmicDevGuy)
#undef NEW_FRONTEND
//---------------------------------------------------------------
#ifndef PSX
...
//---------------------------------------------------------------
#ifdef PSX
//@CosmicDevGuy (2018/05/24): missing typ-specifier - original type is void
