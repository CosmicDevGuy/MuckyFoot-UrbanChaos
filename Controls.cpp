...
#include	"../Headers/cnet.h"
#include	"../Headers/widget.h"
#include	"../Headers/save.h"
#include	"../Headers/dike.h"
...
#include	"../Headers/demo.h"
	...
	#ifndef TARGET_DC
		#include	"../DDLibrary/Headers/FFManager.h"
	#endif
	#include	"../DDLibrary/Headers/DDlib.h"
	#include	"../DDEngine/Headers/texture.h"
#else
	#include	"LIBETC.h"
...
//UPDATE @CosmicDevGuy (2018/05/24): Updated references, so that header files could be located properly (by source and/or header files)
//@CosmicDevGuy (2018/05/24): There's another one in MuckyBasic, but I haven't checked what the differences are
#include "../DDLibrary/Headers/Tga.h"
...
/*		Keys[KB_P5]=0;
	...
	if (ribbon_id!=-1) 
	{
		//@CosmicDevGuy (2018/05/24): missing type specifier - int assumed. Assuming int...
