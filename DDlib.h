...
//@CosmicDevGuy (2018/05/23): Updated references, so that header files could be located (properly)
#include	"../../MFStdLib/Headers/MFStdLib.h"

//@CosmicDevGuy (2018/05/24): This file doesn't exist so for now I've disabled it
