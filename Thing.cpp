...
#ifndef	PSX
	#include	"../DDLibrary/Headers/net.h"	//@CosmicDevGuy (2018/05/24): This file was actually under DDLibrary subdirectory, not DDEngine
#endif
...
void	process_things_tick(SLONG frame_rate_independant)
{
	...
	SLONG	tick_diff;
	//@CosmicDevGuy (2018/05/24): Error: missing type specifier - int assumed. Assuming int...
