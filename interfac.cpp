...
void	init_user_interface(void)
{
	USER_INTERFACE=0;
#ifndef PSX	
	//@CosmicDevGuy (2018/05/24): Undeclared identifier, but it is meant to be a UBYTE (DDEngine/Headers/panel.h (6,14))...
	UBYTE PANEL_scanner_poo=ENV_get_value_number("scanner_follows",	TRUE, "Game");
#endif
#ifdef TARGET_DC
