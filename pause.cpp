...
*/
	...
	if (input&PAUSED_KEY_OKAY)	{
		...
		//@CosmicDevGuy (2018/05/24): PANEL_draw_quad is undefined at this point, but I'm placing a empty macro to define this function
		#define PANEL_draw_quad(int_a,int_b,int_c,int_d,enum_e,ref_f) (printf("Define operations for this function\n"))

		PANEL_draw_quad(320 - 170,
						150 - 20,
						320 + 170,
