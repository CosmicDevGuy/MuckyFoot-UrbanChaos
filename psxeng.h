...
//@CosmicDevGuy (2018/05/24): I don't know if I'm correct but there's a problem here with psxeng.h and a few other files
//either: a) opening twice in VS, with some cases it undoing changes even after saving the file; b) Redefinition errors (especially macros), 
//which I assume may be due to a duplicate linkage issue on compilation (not sure if caused by my #include "fixes")
...
//@CosmicDevGuy (2018/05/24): A change may be required in the makefile, but for now this line is being commented out...
...
//@CosmicDevGuy (2018/05/24): Updated references, so that header files could be located properly (by source and/or header files)
#include	"../../Headers/inline.h"
//@CosmicDevGuy (2018/05/24): This library doesn't appear to exist...
	//#include	"gtemac.h"
#include	"../../psxlib/headers/GDisplay.h"
#include	"../../Headers/night.h"
...
//@CosmicDevGuy (2018/05/24): this is defined elsewhere - keeping it here causes error "'SVector_F': 'struct' type redefinition"
/*
struct SVector_F
{
	float X;
...
//@CosmicDevGuy (2018/05/24): missing type-specifier - int assumed. Does not detect SLONG as a type, adding typedef again...
...
{
	SLONG tmp;
	//@CosmicDevGuy (2018/05/24): Is this in the PSX-SDK?
...
//@CosmicDevGuy(2018/05/24): Redefinition (duplication) problems
#ifndef LOWORD
...
//@CosmicDevGuy (2018/05/24): Redefinition problems
#ifndef FILE_OPEN_ERROR
	#define	FILE_OPEN_ERROR	(-1)
#endif
#ifndef SEEK_MODE_CURRENT
...
extern void FONT2D_DrawString(CBYTE*chr, ULONG x, ULONG y, ULONG rgb=0xffffff, SLONG scale=256, SLONG page=POLY_PAGE_FONT2D, SWORD fade=0);
...
//@CosmicDevGuy (2018/05/24): missing type-specifier - assumed int. Assuming int...
...
//@CosmicDevGuy (2018/05/24): Conflict occurs with Windows8.1 kit's DWORD GetTickCount(void)
